    ...
    <div className=" bg-green-800 min-h-screen">
      ...
      <div className=" px-6 py-32 md:w-[900px] mx-auto md:mx-0">
        ...
        <SearchIcon className=" text-gray-400 md:text-2xl"/> <input type="text" 
         ...
         <div className=" flex
         items-center justify-between w-[450px] text-white gap-1 py-3 mt-14 md:mt-0 sm:w-[500px] md:w-[700px] mx-auto md:mx-0">
          <p className=" text-[12px] md:text-[15px]">Popular:</p>
          <ul className=" flex gap-1">
            <li className=" border px-3 py-1 font-semibold text-[12px] rounded-full md:text-sm md:p">Website Design</li>
            <li className=" border px-3 py-1 font-semibold text-[12px] rounded-full md:text-sm md:p">WordPress</li>
            <li className=" border px-3 py-1 font-semibold text-[12px] rounded-full md:text-sm md:p">Logo Design</li>
            <li className=" border px-3 py-1 font-semibold text-[12px] rounded-full md:text-sm md:p">Ai Services</li>
          </ul>
         </div>
      </div>
    </div>
